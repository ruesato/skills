...
|---|---|---|---|
| `lastcall` | v0.4.0 | [ruesato/agent-skills-lastcall](https://github.com/ruesato/agent-skills-lastcall) | Close out an agentic work session: meters tokens, time, and cost from transcripts, summarizes what actually landed, and gates every durable action behind your approval. Optionally reports your 5-hour and 7-day rate-limit windows. Ships `/lastcall` and `/tally`. |
